...
# Flow Production Tracking Engine for Maya <img src="icon_256.png" alt="Icon" height="24"/>

Flow Production Tracking Integration in Maya
...
| `use_short_menu_name`      | Optionally choose to use "FPTR" as the primary menu name instead of "Flow Production Tracking"                                              | False         |
